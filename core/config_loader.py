    ...
    def load_config(self):
        ...
        try:
            ...
            if os.path.exists(self.config_path):
                ...
                print(Fore.GREEN + f"✅ Config loaded from {self.config_path}" + Style.RESET_ALL)
            else:
                # Create default config
                self.config = self.default_config
                self.save_config()
                print(Fore.YELLOW + f"⚠️ Created default config at {self.config_path}" + Style.RESET_ALL)
