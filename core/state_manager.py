...
class StateManager:
    ...
    def set_state(self, new_state):
        ...
        print(Fore.CYAN + f"🔄 State: {self.previous_state} → {self.current_state}" + Style.RESET_ALL)
    ...
    def force_state(self, new_state):
        ...
        print(Fore.YELLOW + f"⚠️ Force state change: {self.current_state} → {new_state}" + Style.RESET_ALL)
        self.previous_state = self.current_state
        self.current_state = new_state
        self.state_start_time = time.time()
        return True
