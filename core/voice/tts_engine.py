        ...
        try:
            ...
            for voice in voices:
                if "indian" in voice.name.lower() or "hindi" in voice.name.lower():
                    if (
                        "male" in voice.name.lower()
                        or "microsoft david" in voice.name.lower()
                    ):
                        indian_voice = voice
                        break
            ...
            if indian_voice:
                ...
                print(
                    Fore.GREEN
                    + f"✅ Voice set to: {indian_voice.name}"
                    + Style.RESET_ALL
                )
            else:
                # Use default
            ...
            print(
                Fore.RED + f"❌ TTS initialization failed: {str(e)}" + Style.RESET_ALL
            )
