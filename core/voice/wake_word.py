...
class WakeWordDetector:
    ...
    def detect(self):
        ...
        try:
            with self.microphone as source:
                print(Fore.YELLOW + self.config['indicators']['listening'] + " Listening for wake word..." + Style.RESET_ALL, end='\r')
                ...
                try:
                    ...
                    if self.wake_word in text:
                        print(Fore.GREEN + f"\n🎯 Wake word detected: '{text}'" + Style.RESET_ALL)
                        return True
                        
                except sr.UnknownValueError:
                    pass  # No speech detected
                except sr.RequestError:
                    print(Fore.YELLOW + "⚠️ Speech service unavailable" + Style.RESET_ALL)
    ...
    def detect_vosk(self):
        ...
        try:
            ...
            if not os.path.exists(model_path):
                print(Fore.YELLOW + "⚠️ Vosk model not found, using online recognition" + Style.RESET_ALL)
                return self.detect()
