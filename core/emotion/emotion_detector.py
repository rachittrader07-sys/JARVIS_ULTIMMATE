...
class EmotionDetector:
    ...
    def detect_emotion(self, text, voice_features=None):
        ...
        print(
            Fore.MAGENTA + f"❤️ Emotion detected: {combined_emotion}" + Style.RESET_ALL
        )
    ...
    def combine_emotions(text_emotion, voice_emotion):
        ...
        emotion_weights = {text_emotion: 0.7, voice_emotion: 0.3}
    ...
    def get_emotion_response(emotion):
        ...
        responses = {
            "happy": {"prefix": "Great! ", "suffix": " Sir 😊", "tone": "excited"},
            "sad": {"prefix": "I understand. ", "suffix": " Sir 🫂", "tone": "soft"},
            "angry": {"prefix": "I apologize. ", "suffix": " Sir 🫡", "tone": "calm"},
            "excited": {"prefix": "Awesome! ", "suffix": " Sir 🎉", "tone": "excited"},
            "calm": {"prefix": "Sure. ", "suffix": " Sir 🧘", "tone": "calm"},
            "neutral": {"prefix": "", "suffix": " Sir ✅", "tone": "neutral"},
        }
