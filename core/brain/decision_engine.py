...
class DecisionEngine:
    ...
    def decide(self, intent, entities, context):
        ...
        print(Fore.YELLOW + self.config['indicators']['thinking'] + " Making decision..." + Style.RESET_ALL)
    ...
    def get_known_apps():
        ...
        default_apps = [
            'chrome', 'firefox', 'edge', 'vscode', 'notepad',
            'calculator', 'cmd', 'powershell', 'python',
            'excel', 'word', 'powerpoint', 'outlook',
            'photoshop', 'premiere', 'spotify', 'whatsapp',
            'discord', 'telegram'
        ]
    ...
    def is_dangerous_app(app_name):
        ...
        dangerous_apps = [
            ...
            'diskpart', 'format', 'shutdown', 'del', 'rm'
        ]
