...
class MemoryController:
    ...
    def add_short_term(self, entry):
        ...
        print(Fore.GREEN + f"🧠 Memory updated: {entry.get('action', 'unknown')}" + Style.RESET_ALL)
    ...
    def load_memory(self):
        ...
        try:
            ...
            print(Fore.GREEN + f"🧠 Memory loaded: {len(self.short_term_memory)} short, {len(self.long_term_memory)} long" + Style.RESET_ALL)
    ...
    def get_memory_stats(self):
        ...
        stats = {
            ...
            'patterns_count': len([m for m in self.long_term_memory if m.get('type') == 'pattern']),
