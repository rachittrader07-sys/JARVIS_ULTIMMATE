...
class AppDiscovery:
    ...
    def discover_apps(self):
        ...
        print(Fore.YELLOW + "🔍 Discovering installed applications..." + Style.RESET_ALL)
        ...
        print(Fore.GREEN + f"✅ Discovered {len(self.installed_apps)} applications" + Style.RESET_ALL)
        ...
        for root, dirs, files in os.walk(directory):
            for file in files:
                if file.endswith('.exe'):
                    ...
                    if not any(sys_exe in file.lower() for sys_exe in ['uninstall', 'setup', 'install']):
    ...
    def get_apps_by_category(self):
        ...
        dev_keywords = ['visual studio', 'vscode', 'pycharm', 'intellij', 'eclipse', 'android studio', 'code', 'editor']
        media_keywords = ['spotify', 'vlc', 'media player', 'music', 'video', 'photoshop', 'premiere']
        comm_keywords = ['whatsapp', 'discord', 'telegram', 'skype', 'zoom', 'teams', 'slack']
        productivity_keywords = ['office', 'word', 'excel', 'powerpoint', 'outlook', 'notepad', 'calculator']
        system_keywords = ['control panel', 'task manager', 'cmd', 'powershell', 'regedit', 'device manager']
