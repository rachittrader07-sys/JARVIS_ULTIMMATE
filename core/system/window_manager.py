...
class WindowManager:
    ...
    def execute(self, params):
        ...
        print(Fore.YELLOW + f"🪟 Window action: {action} on {window_target}" + Style.RESET_ALL)
    ...
    def manage_current_window(action):
        ...
        try:
            ...
            print(Fore.GREEN + f"✅ Window {action}: {active_window.title}" + Style.RESET_ALL)
    ...
    def manage_all_windows(action):
        ...
        try:
            ...
            if action == 'minimize':
                ...
                return {'success': False, 'error': f'Unknown action for all windows: {action}'}
            
            print(Fore.GREEN + f"✅ All windows {action}: {len(windows)} windows" + Style.RESET_ALL)
    ...
    def manage_specific_window(self, window_title, action):
        ...
        try:
            ...
            if action == 'minimize':
                ...
                # Resize window
                self.resize_window(window, params.get('width', 800), params.get('height', 600))
            else:
                return {'success': False, 'error': f'Unknown action: {action}'}
    ...
    def arrange_windows(arrangement='cascade'):
        ...
        try:
            ...
            return {'success': True, 'arrangement': arrangement, 'windows': len(windows)}
