...
class UnknownHandler:
    ...
    def query_openrouter(self, action, params):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    Fore.GREEN + f"✅ AI Response: {ai_text[:100]}..." + Style.RESET_ALL
                )
                return ai_text
            else:
                print(
        ...
        try:
            ...
            if json_match:
                ...
                if confidence > 0.7 and action:
                    ...
                    clarification = (
                        f"I think you want {understanding}. Can you please clarify?"
                    )
    ...
    def fallback_to_basic(self, action, params):
        ...
        # Default fallback
        self.tts.speak(
            "Sir, I didn't understand that command. Can you please rephrase?"
        )
        return {
            "success": False,
