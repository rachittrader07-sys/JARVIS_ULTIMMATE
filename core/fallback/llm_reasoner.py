...
class LLMReasoner:
    def __init__(self, config):
        ...
        self.endpoint = self.openrouter_config.get('endpoint', 'https://openrouter.ai/api/v1/chat/completions')
...
- Be empathetic and understanding"""
    ...
    def make_api_request(self, prompt, max_tokens):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(Fore.GREEN + f"🤖 AI Response: {cleaned_response[:100]}..." + Style.RESET_ALL)
                return cleaned_response
            else:
                print(Fore.RED + f"❌ API request failed: {response.status_code}" + Style.RESET_ALL)
                return None
    ...
    def fallback_reasoning(self, query, context):
        ...
        elif any(word in query_lower for word in ['how to', 'kaise kare', 'kaise karna']):
            # How-to question
    ...
    def analyze_sentiment(self, text):
        ...
        try:
            ...
            if response:
                ...
                sentiment_words = ['positive', 'negative', 'neutral', 'happy', 'sad', 'angry', 'excited', 'calm']
    ...
    def generate_response_for_unknown(self, user_input, context):
        ...
        return response if response else "Sir, main ye command samajh nahi paya. Kya aap dobara bata sakte hain?"
