...
class ConfirmationEngine:
    ...
    def execute(self, params):
        ...
        if not message:
            ...
            return {"success": False, "error": "No confirmation message provided"}
    ...
    def ask_confirmation(self, message, timeout=10, require_explicit=True):
        ...
        try:
            ...
            print(
                Fore.CYAN
                + "🎤 Listening for confirmation (say YES or NO)..."
                + Style.RESET_ALL
            )
    ...
    def clear_history(self):
        ...
        return {"success": True, "message": "Confirmation history cleared"}
