...
class WebFallback:
    def __init__(self, config, tts):
        ...
        self.fallback_services = {
            ...
            "news": {"primary": "newsapi", "fallback": "bing_news", "backup": "reddit"},
            "search": {"primary": "google", "fallback": "duckduckgo", "backup": "bing"},
            "translate": {
        ...
        try:
            ...
            try:
                ...
                if api_key:
                    ...
                    if response.status_code == 200:
                        ...
                        self.tts.speak(
                            f"Weather in {city}: {desc}, temperature {temp}°C, humidity {humidity}%"
                        )
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    desc = weather_data["current_condition"][0]["weatherDesc"][0][
                        "value"
                    ]
    ...
    def get_news_fallback(self, query="", data=None):
        ...
        try:
                ...
                if api_key:
                    ...
                    if response.status_code == 200:
                        ...
                        if "value" in news_data:
                            headlines = [
                                item["name"] for item in news_data["value"][:3]
                            ]
            ...
            return {"success": False, "error": "All news services failed"}
    ...
    def translate_fallback(self, query="", data=None):
        ...
        try:
            ...
            target = (
                data.get("target", "hi") if data else "hi"
    ...
    def currency_fallback(self, query="", data=None):
        ...
        try:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if to_curr in rates:
                        ...
                        self.tts.speak(
                            f"{amount} {from_curr} equals {converted:.2f} {to_curr}"
                        )
            ...
            if key in fallback_rates:
                ...
                self.tts.speak(
                    f"Approximately {amount} {from_curr} equals {converted:.2f} {to_curr}"
                )
    ...
    def get_time_fallback(self, query="", data=None):
        ...
        try:
            ...
            return {"success": False, "error": f"Could not get time for {location}"}
            ...
            for service_url in dns_services:
                try:
                    ...
                    if response.status_code == 200:
                        dns_data = (
                            response.text
                            if "hackertarget" in service_url
                            else response.json()
                        )
