...
class WebSearch:
    ...
    def search_google(query):
        ...
        try:
            ...
            return {"success": True, "engine": "google", "url": url, "query": query}
        except Exception as e:
            return {"success": False, "error": str(e)}
            ...
            with DDGS() as ddgs:
                ...
                if results:
                    ...
                    if url:
                        ...
                        print(
                            Fore.GREEN
                            + f"✅ DuckDuckGo result opened: {url}"
                            + Style.RESET_ALL
                        )
    ...
    def search_bing(query):
        ...
        try:
            ...
            return {"success": True, "engine": "bing", "url": url, "query": query}
        except Exception as e:
            return {"success": False, "error": str(e)}
    ...
    def search_google_direct(query):
        ...
        try:
            ...
            return {"success": False, "error": "All search methods failed"}
