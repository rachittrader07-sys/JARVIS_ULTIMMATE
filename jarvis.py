...
class JARVIS:
    ...
    def initialize(self):
        ...
        try:
            print(Fore.YELLOW + "🎯 Initializing JARVIS Components..." + Style.RESET_ALL)
            ...
            # Test TTS
            self.tts.speak("Jarvis initialization complete sir. I am ready to assist you.")
            
            self.logger.info("✅ JARVIS Initialization Complete")
            print(Fore.GREEN + Style.BRIGHT + "✅ JARVIS READY TO ASSIST SIR!" + Style.RESET_ALL)
    ...
    def main_loop(self):
        ...
        print(Fore.CYAN + "\n🎯 JARVIS is now active. Say 'Jarvis' to wake me up!" + Style.RESET_ALL)
    ...
    def on_wake_detected(self):
        ...
        print(Fore.GREEN + "\n" + self.config['indicators']['listening'] + " Wake word detected! Listening..." + Style.RESET_ALL)
    ...
    def process_command(self, command_text):
        ...
        try:
            ...
            print(Fore.YELLOW + self.config['indicators']['thinking'] + " Analyzing intent..." + Style.RESET_ALL)
            ...
            response = self.decision_engine.decide(intent, entities, self.current_context)
    ...
    def shutdown(self):
        ...
        try:
            ...
            print(Fore.GREEN + f"   Success Rate: {success_rate:.1f}%" + Style.RESET_ALL)
...
def main():
    ...
    if jarvis.initialize():
        ...
        print(Fore.RED + "❌ JARVIS failed to initialize. Please check the logs." + Style.RESET_ALL)
